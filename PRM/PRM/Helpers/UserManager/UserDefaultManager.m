...
//
//-(void)saveJumpDeractionStatus:(JumpDeraction)jumpDeraction{
//    [[NSUserDefaults standardUserDefaults] setValue:@(jumpDeraction) forKey:@"jumpDeraction"];
//    [[NSUserDefaults standardUserDefaults] synchronize];
//
//}
//-(JumpDeraction)getJumpDeractionStatus{
//    return (JumpDeraction)[[NSUserDefaults standardUserDefaults] objectForKey:@"jumpDeraction"];
//}
