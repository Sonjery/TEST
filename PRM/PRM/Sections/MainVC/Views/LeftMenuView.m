...
-(void)awakeFromNib{
    ...
    // 当前应用名称
    self.versionLabel.text  = [infoDictionary objectForKey:@"CFBundleVersion"];
    self.userNameLabel.text = [[UserDefaultManager shareUserDefaultManager] getUserName];
}
...
- (void)inputOfSightMenuView{
    NSDictionary *infoDictionary = [[NSBundle mainBundle] infoDictionary];
    // 当前应用名称
    self.versionLabel.text  = [NSString  stringWithFormat:@"%@", [infoDictionary objectForKey:@"CFBundleVersion"]];
    self.userNameLabel.text = [NSString stringWithFormat:@"%@", [[UserDefaultManager shareUserDefaultManager] getUserName]];
